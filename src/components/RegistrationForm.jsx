...
const handlelogin = () =>{
    ...
    return (
        ...
        <h2 style={{marginBottom:'10px', textAlign:"center", fontFamily:'fantasy', color:'#76D7C4',padding:'10px'}}>Registration Form</h2>
        <Form
            name="basic"
            labelCol={{
                span: 8,
        ...
        >
            ...
            <Form.Item
                ...
                rules={[
                    ...
                    {
                        min : 7,
                        message : 'Phone number must not have less than 10 digits'
                    },
                    {
                        max : 15,
                        message : 'Phone number must not have more than 10 digits'
                    },
                    {
