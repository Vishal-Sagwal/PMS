...
const PricingPage = () => {
  ...
  <div style={{display:'flex', justifyContent:'center',alignItems:'center', flexWrap:'wrap',gap:'80px'}}>
    <div >
      <Card hoverable={true} bordered={false} style={{width:'110%',height:'27rem',backgroundColor:'#FDFEFE', marginTop:'100px'}}>
        <h2 style={{fontFamily:'monospace', marginBottom:'40px',}}>FREE</h2>
        ...
        <Button style={{backgroundColor:'#3498DB', color:'white', width:'200px',height:'50px'}} onClick={handleFree}>Start For Free</Button>
      </Card>
    </div>
    <div>
      <Card hoverable={true} bordered={false} style={{width:'110%',height:'27rem',backgroundColor:'#FDFEFE', marginTop:'100px'}}>
        <h2 style={{fontFamily:'monospace', marginBottom:'40px',}}>GOLD</h2>
        <div style={{display:'flex', flexDirection:'column',gap:'20px'}}>
        ...
        <Button style={{backgroundColor:'#FF7F50', color:'white', width:'200px', height:'50px'}} onClick={handleGold}>GET STARTED</Button>
      </Card>
    </div>
    <div>
      <Card hoverable={true}  bordered={false} style={{width:'110%',height:'27rem',backgroundColor:'#FDFEFE', marginTop:'100px'}}>
        <h2 style={{fontFamily:'monospace', marginBottom:'40px',}}>PLATINIUM</h2>
        <div style={{display:'flex', flexDirection:'column',gap:'20px'}}>
        ...
        <Button style={{backgroundColor:'#FF7F50', color:'white', width:'200px',height:'50px'}} onClick={handlePlatinium}>GET STARTED</Button>
      </Card>
    </div>
  </div>
  </div>
